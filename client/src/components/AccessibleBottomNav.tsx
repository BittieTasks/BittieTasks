...
import { Home, Search, Plus, MessageCircle, User, Trophy, CheckSquare } from "lucide-react";
...
const AccessibleBottomNav = () => {
  ...
  return (
    <nav 
      ...
      className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-2 z-50 safe-area-pb"
      role="navigation"
...
export default AccessibleBottomNav;