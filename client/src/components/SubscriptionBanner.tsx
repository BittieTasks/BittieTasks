  ...
  const getBannerContent = () => {
    ...
    if (tier === "free") {
      return {
        ...
        description: "Upgrade to Pro: 50 tasks/month + Keep 85% of earnings + Ad-free ($19.99/month)",
        ctaText: "See Plans",
    ...
    if (tier === "pro") {
      return {
        ...
        description: "Upgrade to Premium: Unlimited tasks + Keep 90% of earnings + Exclusive opportunities ($39.99/month)",
